...
(function () {
  ...
  window.__ELSOLAR__ = {
    ...
    brand: {
      ...
      // ESLOGAN — pendiente de aprobación del cliente. Tres opciones sobrias,
      // sin "eterno" ni promesas comerciales. La primera queda provisoria;
      // no se muestra todavía en ninguna página. Para usarla, hay que
      // pegarla a mano en el <p class="hero-sub"> del hero y en el footer.
      //
      // Opción 1 (provisoria): "Un parque organizado, cerca de la ciudad."
      // Opción 2:              "Entorno natural, cuidado constante."
      // Opción 3:              "Cerca de la ciudad, en medio del verde."
      eslogan: null,

      fundacion: 1995,
      superficieHectareas: 8,

      // CUIT — NO PUBLICAR TODAVÍA. El número aportado empieza con 27,
      // prefijo de persona física en Argentina, no de una sociedad. Antes de
      // mostrarlo en el pie del sitio hay que confirmar con el cliente si
      // el cementerio opera bajo esa persona física, o si existe una razón
      // social con CUIT propio (prefijo 30 o 33) que sea la correcta.
      // Por eso queda comentado y no se imprime en el footer.
      // cuit: "27-06624986-2",
      cuit: null
    },
    ...
    contacto: {
      ...
      // Facebook — la planilla del cliente sólo trae el nombre de la
      // página ("Parque El Solar"), no la URL exacta. Hasta tenerla
      // confirmada, el sitio muestra el nombre como texto simple, sin
      // enlace, para no publicar una dirección adivinada. Cuando llegue
      // la URL real, agregarla acá y convertir el texto en <a> en
      // index.html (están marcados con un comentario "FACEBOOK-URL").
    ...
    // Las respuestas marcadas "(a confirmar)" son un texto sobrio de
    // partida: conviene que el cliente las revise antes de publicarlas.
    faq: [
      {
        pregunta: "¿Puedo comprar una parcela por adelantado? ¿Me obliga a algo?",
        respuesta: "Sí. Adquirir una parcela con anticipación es una decisión habitual y no genera ninguna obligación adicional más allá de la parcela en sí. Podés consultar ubicaciones y valores cuando quieras, sin apuro. (a confirmar)"
      },
      {
        pregunta: "¿Cómo se abona? ¿Hay financiación?",
        respuesta: "Se puede abonar en efectivo, por transferencia o con débito. Las formas de pago y las opciones de financiación se conversan de forma personal con la administración, según cada caso. (a confirmar)"
      },
      {
      ...
      },
      {
        ...
        respuesta: "Sí, siempre que esté con correa y bajo tu cuidado. Para el ingreso a espacios cerrados, como la capilla, te recomendamos consultarlo antes con el personal del parque. (a confirmar)"
      },
      {
        pregunta: "¿Hay misas?",
    ...
    galeria: [
      { id: "hero", src: "assets/img/hero.webp", alt: "Caminería arbolada del parque, con luz de mañana." },
      { id: "parque-jardines", src: "assets/img/parque-jardines.webp", alt: "Jardines y senderos del parque, entre árboles y flores." }
    ]
  };
})();
